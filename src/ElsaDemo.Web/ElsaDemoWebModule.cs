...
using DbContextOptionsBuilderExtensions = Elsa.Persistence.EntityFramework.PostgreSql.DbContextOptionsBuilderExtensions;
            ...
            context.Services.AddElsa(elsa =>
            {
                elsa
                    .UseEntityFrameworkPersistence(ef =>
                    {
                        ...
                        {
                            DbContextOptionsBuilderExtensions.UsePostgreSql(ef, connectionString);
                        }
                    })
